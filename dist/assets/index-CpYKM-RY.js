...
`}})]})},rx=()=>{const{isChanging:e}=U();return e?n.jsxs("div",{className:"language-transition-overlay",children:[n.jsxs("div",{className:"transition-content",children:[n.jsx("img",{src:Oa,alt:"Logo",className:"transition-logo"}),n.jsx("div",{className:"transition-loader"})]}),n.jsx("style",{dangerouslySetInnerHTML:{__html:`

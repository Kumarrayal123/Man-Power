      ...
      <div className="container hero-wrapper">
        <section className="home-hero">
          <div className="home-hero__content">
            ...
            <p className="home-hero__text">Looking for visionary leaders to steer your organization? manpower.ae provides confidential, high-quality executive search services across all industries in the UAE.</p>

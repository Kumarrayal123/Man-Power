      ...
      <div className="container hero-wrapper">
        <section className="home-hero">
          <div className="home-hero__content">
            ...
            <p className="home-hero__text">Looking for professional, SIRA-licensed security personnel for your business or facility? manpower.ae provides trusted, industry-compliant security staffing solutions across the UAE.</p>
